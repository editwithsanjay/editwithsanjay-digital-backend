...
app.use(cors({ origin: [process.env.FRONTEND_URL, 'http://localhost:5173', 'https://editwithsanjay-digital-frontend-opal.vercel.app','https://editwithsanjay-digital-frontend.vercel.app', 'https://editwithsanjay-digital-store-2.netlify.app', 'https://editwithsanjay.in', 'https://www.editwithsanjay.in'], credentials: true }))
